      ...
      <div className="w-full py-6 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-700 mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-semibold text-yellow-400 mb-4">Today's Expert Tips</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600">
                <h3 className="text-yellow-400 font-medium mb-2 text-sm sm:text-base">Golden Ank</h3>
                <p className="text-green-400 text-2xl sm:text-3xl font-bold">1-4-6-9</p>
              </div>
              <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600">
                <h3 className="text-yellow-400 font-medium mb-2 text-sm sm:text-base">Motor Patti</h3>
                <p className="text-green-400 text-2xl sm:text-3xl font-bold">12469</p>
              </div>
              <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600">
                <h3 className="text-yellow-400 font-medium mb-2 text-sm sm:text-base">Jodi</h3>
          ...
          <div className="bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-700">
            <h2 className="text-lg sm:text-xl font-semibold text-yellow-400 mb-4">Tips & Strategies</h2>
